...
class BaselineLocalFLC(Local_Base, BaselineFLC):
    def __init__(self, *args, train_size=(1, 3, 256, 256), fast_imp=False, **kwargs):
        Local_Base.__init__(self)
        BaselineFLC.__init__(self, *args, **kwargs)
...
if __name__ == '__main__':
    ...
    net = BaselineFLC(img_channel=img_channel, width=width, middle_blk_num=middle_blk_num,
